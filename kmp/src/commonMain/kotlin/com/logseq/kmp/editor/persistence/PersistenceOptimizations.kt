...
class PersistenceDebouncer(
    ...
    private val logger = com.logseq.kmp.logging.Logger("PersistenceDebouncer")
...
class PersistencePerformanceMonitor(
    ...
    private val logger = com.logseq.kmp.logging.Logger("PersistencePerfMonitor")
...
class PersistenceOptimizer {
    private val logger = com.logseq.kmp.logging.Logger("PersistenceOptimizer")
