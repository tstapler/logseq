        ...
        return writeMutex.withLock {
            try {
                ...
                if (result != null) {
                    ...
                    val remainingOldSiblings = siblings.filter { it.uuid != block.uuid }
