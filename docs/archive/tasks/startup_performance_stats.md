...
### Story 1: Instrumentation & Collection [1 day]
...
### Story 2: Performance Dashboard UI [1-2 days]
...
#### Task 1.1: Performance Monitor Infrastructure [2h]
...
#### Task 1.2: Instrument GraphLoader [2h]
...
#### Task 2.1: Performance Dashboard Composable [3h]
