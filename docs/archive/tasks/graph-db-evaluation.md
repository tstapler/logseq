...
**Context Boundary:**
- Files: `kmp/src/commonMain/kotlin/com/logseq/kmp/repository/SqlDelightRepositories.kt`, `kmp/src/commonMain/sqldelight/com/logseq/kmp/db/LogseqDatabase.sq` (3 files)
...
### Task 2.1
**Files to Load:**
- `kmp/src/commonMain/sqldelight/com/logseq/kmp/db/LogseqDatabase.sq` - Current schema
