...
2. `kmp/src/commonMain/sqldelight/com/logseq/kmp/db/LogseqDatabase.sq` - Recursive CTEs
...
- [ ] Query response within 2x of DataScript baseline
- [ ] Cache hit rate > 80% for repeated queries
- [ ] No timeouts for typical hierarchy depths (≤20 levels)
...
- Load SqlDelightBlockRepository.kt and LogseqDatabase.sq
- Add depth limiting to recursive CTEs
