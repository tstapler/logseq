...
import com.logseq.kmp.model.Reference
...
**Files** (3 files):
1. `kmp/src/commonMain/sqldelight/com/logseq/kmp/db/LogseqDatabase.sq` (modify)
...
2. `kmp/src/commonMain/sqldelight/com/logseq/kmp/db/LogseqDatabase.sq` (reference)
...
1. `kmp/src/commonMain/sqldelight/com/logseq/kmp/db/LogseqDatabase.sq`
