...
3. `kmp/src/commonMain/sqldelight/com/logseq/kmp/db/LogseqDatabase.sq` - Add plugin_data table
...
3. `kmp/src/commonMain/sqldelight/com/logseq/kmp/db/LogseqDatabase.sq` - Add optimized queries
...
4. `kmp/src/commonMain/sqldelight/com/logseq/kmp/db/LogseqDatabase.sq` - Add FTS queries
...
2. `kmp/src/commonMain/sqldelight/com/logseq/kmp/db/LogseqDatabase.sq` - Lines ~1-50 (schema)
...
2. `kmp/src/commonMain/sqldelight/com/logseq/kmp/db/LogseqDatabase.sq` - Lines ~70-120 (hierarchy queries)
...
- `kmp/src/commonMain/sqldelight/com/logseq/kmp/db/LogseqDatabase.sq` (modify)
