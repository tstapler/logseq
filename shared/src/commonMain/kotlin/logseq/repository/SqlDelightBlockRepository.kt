...
import logseq.model.Block as DomainBlock
...
class SqlDelightBlockRepository(
    ...
    private fun com.logseq.kmp.db.Blocks.toDomainBlock(): DomainBlock {
    ...
    private fun DomainBlock.toDbBlock(): com.logseq.kmp.db.Blocks {
        ...
        return com.logseq.kmp.db.Blocks(
            id = id,
            uuid = uuid,
            page_id = pageId,
            parent_id = parentId,
