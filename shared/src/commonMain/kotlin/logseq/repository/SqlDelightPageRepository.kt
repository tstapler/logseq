...
import logseq.model.Page as DomainPage
...
class SqlDelightPageRepository(
    ...
    private fun com.logseq.kmp.db.Pages.toDomainPage(): DomainPage {
    ...
    private fun DomainPage.toDbPage(): com.logseq.kmp.db.Pages {
        ...
        return com.logseq.kmp.db.Pages(
            id = id,
            uuid = uuid,
            name = name,
            namespace = namespace,
